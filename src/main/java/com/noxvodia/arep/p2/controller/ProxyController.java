...
public class ProxyController {
    ...
    public Object linealRequest(@RequestParam int[] list, @RequestParam int search) {
        ...
        String url = backendUrl + "/lineal?list=" +list+"&value="+search ;
        return restTemplate.getForObject(url, Object.class);
    }

    @GetMapping("/proxy/binaria")
    public Object binariaRequest(@RequestParam int[] list, @RequestParam int search) {
        String backendUrl = getNextBackendUrl();
        RestTemplate restTemplate = new RestTemplate();
        String url = backendUrl + "/binaria?list=" +list+"&value="+search ;
        return restTemplate.getForObject(url, Object.class);
    }
